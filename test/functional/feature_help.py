...
"""Verify that starting litelira with -h works as expected."""

from test_framework.test_framework import LiteLiraTestFramework
from test_framework.util import assert_equal

class HelpTest(LiteLiraTestFramework):
    ...
    def run_test(self):
        self.log.info("Start litelira with -h for help text")
        ...
        self.log.info("Start litelira with -version for version information")
        ...
        self.log.info("Start litelirad with -fakearg to make sure it does not start")
