...
class SegWitTest(LiteLiraTestFramework):
    ...
    def test_p2sh_witness(self):
        ...
        # segwit activation.  Note that older litelirad's that are not
    ...
    def test_submit_block(self):
        ...
        # Now redo commitment with the standard nonce, but let litelirad fill it in.
