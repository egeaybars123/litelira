...
# TestP2PConn: A peer we use to send messages to litelirad, and store responses.
...
class CompactBlocksTest(LiteLiraTestFramework):
    ...
    # This test actually causes litelirad to (reasonably!) disconnect us, so do this last.
    ...
    # Test that litelirad requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for litelirad to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # litelirad will not send blocktxn responses for blocks whose height is
