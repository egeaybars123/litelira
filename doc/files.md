...
* litelira.conf: contains configuration settings for litelirad or litelira-qt
* litelirad.pid: stores the process id of litelirad while running
...
* debug.log: contains debug information and general logging generated by litelirad or litelira-qt
