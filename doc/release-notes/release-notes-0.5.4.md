LiteLira version 0.5.4 is now available for download at:
http://sourceforge.net/projects/litelira/files/LiteLira/litelira-0.5.4/
...
http://gitorious.org/litelira/litelirad-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix LiteLira-Qt notifications under Growl 1.3.
Increase required age of LiteLira-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxLiteLira properly when installing LiteLira-Qt over it. (Windows)
