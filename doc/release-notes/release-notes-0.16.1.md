LiteLira Core version 0.16.1 is now available from:

  <https://liteliracore.org/bin/litelira-core-0.16.1/>
...
- #12843 `df38b13` Test starting litelirad with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure litelirad processes are cleaned up when tests end (sdaftuar)
