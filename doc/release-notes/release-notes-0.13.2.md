LiteLira Core version 0.13.2 is now available from:

  <https://litelira.org/bin/litelira-core-0.13.2/>
...
- #8908 `4a974b2` Update litelira-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow litelira-tx to create v2 transactions (btcdrak)
