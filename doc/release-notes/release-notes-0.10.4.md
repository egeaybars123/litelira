LiteLira Core version 0.10.4 is now available from:

  <https://litelira.org/bin/litelira-core-0.10.4/>
...
- #6953 `43c2789` Split litelira-tx into its own package
- #6953 `dfe0d4d` Include litelira-tx binary on Debian/Ubuntu
