LiteLira Core version 0.9.4 is now available from:

  https://litelira.org/bin/0.9.4/
...
this update is incompatible with the LiteLira system and could lead to consensus
forks.

LiteLira Core released binaries from https://litelira.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~litelira/+archive/ubuntu/litelira
- A third-party or self-compiled LiteLira Core

upgrade to LiteLira Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
