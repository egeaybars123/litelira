LiteLira-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/litelira/files/LiteLira/litelira-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the LiteLira
...
New/changed settings (command-line or litelira.conf file)
--------------------------------------------------------
