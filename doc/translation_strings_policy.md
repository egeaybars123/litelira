...
This document provides guidelines for internationalization of the LiteLira Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `litelira_en.ts` remains unchanged.
