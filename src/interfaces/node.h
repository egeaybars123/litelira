...
#ifndef LITELIRA_INTERFACES_NODE_H
#define LITELIRA_INTERFACES_NODE_H
...
//! Top-level interface for a litelira node (litelirad process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // LITELIRA_INTERFACES_NODE_H
