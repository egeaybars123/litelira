 ...
 */
#ifndef LITELIRA_UTIL_H
#define LITELIRA_UTIL_H
...
extern const char * const LITELIRA_CONF_FILENAME;
extern const char * const LITELIRA_PID_FILENAME;
...
{
    std::string s = strprintf("litelira-%s", name);
