...
#ifndef LITELIRA_TEST_SCRIPTNUM10_H
#define LITELIRA_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from LiteLira Core 0.10.0, for cross-comparison.
 */
public:
