...
#ifndef LITELIRA_KEYSTORE_H
#define LITELIRA_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/litelira/bips/blob/master/bip-0013.mediawiki
