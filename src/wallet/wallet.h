...
#ifndef LITELIRA_WALLET_WALLET_H
#define LITELIRA_WALLET_WALLET_H
...
public:
     ...
     * on this litelira node, and set to 0 for transactions that were created
...
#endif // LITELIRA_WALLET_WALLET_H
