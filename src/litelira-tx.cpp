...
static void SetupLiteLiraTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " litelira-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  litelira-tx [options] <hex-tx> [commands]  Update hex-encoded litelira transaction\n" +
            "or:     litelira-tx [options] -create [commands]   Create hex-encoded litelira transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded litelira transaction
