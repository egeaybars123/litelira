...
#ifndef LITELIRA_QT_SPLASHSCREEN_H
#define LITELIRA_QT_SPLASHSCREEN_H
 ...
 *
 * @note this is intentionally not a QSplashScreen. LiteLira Core initialization
...
#endif // LITELIRA_QT_SPLASHSCREEN_H
