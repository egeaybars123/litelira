...
#ifndef LITELIRA_QT_LITELIRAUNITS_H
#define LITELIRA_QT_LITELIRAUNITS_H
...
/** LiteLira unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class LiteLiraUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit LiteLiraUnits(QObject *parent);

    /** LiteLira units.
      @note Source: https://en.litelira.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef LiteLiraUnits::Unit LiteLiraUnit;

#endif // LITELIRA_QT_LITELIRAUNITS_H
