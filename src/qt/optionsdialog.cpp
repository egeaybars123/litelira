    ...
    mapper(0)
{
    ...
    ui->liteliraAtStartup->setToolTip(ui->liteliraAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->liteliraAtStartup->setText(ui->liteliraAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openLiteLiraConfButton->setToolTip(ui->openLiteLiraConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new LiteLiraUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->liteliraAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openLiteLiraConfButton_clicked()
{
